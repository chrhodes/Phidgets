...
namespace VNCPhidgets21Explorer.Presentation.ViewModels
{
    public class InterfaceKit1018ViewModel : EventViewModelBase, IInterfaceKitViewModel, IInstanceCountVM
    {
        ...
        public Configuration.Host SelectedHost
        {
            ...
            set
            {
                if (_selectedHost == value)
                    return;
                _selectedHost = value;
                InterfaceKits = _selectedHost.InterfaceKits.ToList<Configuration.InterfaceKit>();
                OnPropertyChanged();
            }
        }

        private IEnumerable<Configuration.InterfaceKit> _InterfaceKits;
        public IEnumerable<Configuration.InterfaceKit> InterfaceKits
        {
            get
            {
        ...
        private Configuration.InterfaceKit _selectedInterfaceKit;
        public Configuration.InterfaceKit SelectedInterfaceKit
        {
        ...
        private IEnumerable<Configuration.Sensor> _Sensors2;
        public IEnumerable<Configuration.Sensor> Sensors2
        {
            get
            {
                if (null == _Sensors2)
